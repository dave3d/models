...
So as soon as I saw that GitHub supported STL file viewing a repository, I had to try it out.
...
know about Martin Newell's Utah Teapot model.  While he was a grad student 
...
So my teapot model is an iso-surface extracted from that CT scan.  If you've
...
of the format, you can see that several different companies have kind of hacked it
...
My color test model is of the Visible Male head, produced by the Office of High
Performance Computing and Communication at the National Library of Medicine
